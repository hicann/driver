...
static const char g_drv_error_code[] =
    ...
    "               \"Solution\": \"Ensure that the required memory is available. Take measures such as stopping unnecessary processes to free memory.\"\n"
    "           }\n"
    "       },\n"
    "       {\n"
    "           \"errClass\": \"Driver Errors\",\n"
    ...
    "                                 enable the single-device multi-container function by using npu-smi set -t device-share -i id -c chip_id -d value.\"\n"
    "           }\n"
    "       },\n"
    "       {\n"
    "           \"errClass\": \"Driver Errors\",\n"
    ...
    "           \"ErrCode\": \"EL0022\",\n"
    "           \"ErrMessage\": \"The number of SQ and CQ resources exceeds the upper limit. The maximum number of resources is %s.\",\n"
    "           \"Arglist\": \"max_value\",\n"
    "           \"suggestion\": {\n"
    "               \"Possible Cause\": \"N/A\",\n"
    "               \"Solution\": \"Check the allocation and release of SQ and CQ resources do not exceed the upper limit.\"\n"
    "            }\n"
    "       }\n"
    "   ]\n"
    "}\n";
