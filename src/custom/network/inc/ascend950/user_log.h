...
#define roce_err(fmt, args...)    UsrDlogForC(NET, ERROR_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_warn(fmt, args...)   UsrDlogForC(NET, WARN_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_info(fmt, args...)   UsrDlogForC(NET, INFO_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_dbg(fmt, args...)    UsrDlogForC(NET, DEBUG_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_run_err(fmt, args...)    UsrDlogForC(NET | RUN_LOG_MASK, ERROR_LEVEL, "%s: " fmt, \
    __func__, ##args)
#define roce_run_warn(fmt, args...)   UsrDlogForC(NET | RUN_LOG_MASK, WARN_LEVEL, "%s: " fmt, \
    __func__, ##args)
#define roce_run_info(fmt, args...)   UsrDlogForC(NET | RUN_LOG_MASK, INFO_LEVEL, "%s: " fmt, \
    __func__, ##args)
#define roce_run_dbg(fmt, args...)    UsrDlogForC(NET | RUN_LOG_MASK, DEBUG_LEVEL, "%s: " fmt, \
    __func__, ##args)
...
#define roce_err(fmt, args...)    usr_dlog(NET, ERROR_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_warn(fmt, args...)   usr_dlog(NET, WARN_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_info(fmt, args...)   usr_dlog(NET, INFO_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_dbg(fmt, args...)    usr_dlog(NET, DEBUG_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_run_err(fmt, args...)    usr_dlog(NET | RUN_LOG_MASK, ERROR_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_run_warn(fmt, args...)   usr_dlog(NET | RUN_LOG_MASK, WARN_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_run_info(fmt, args...)   usr_dlog(NET | RUN_LOG_MASK, INFO_LEVEL, "%s: " fmt, __func__, ##args)
#define roce_run_dbg(fmt, args...)    usr_dlog(NET | RUN_LOG_MASK, DEBUG_LEVEL, "%s: " fmt, __func__, ##args)
