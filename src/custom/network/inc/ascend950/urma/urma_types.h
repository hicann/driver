...
/* Due to the difference on how attributes are organized on different system os,
 * the size of urma_tp_attr_value differs.
 * May not be compatible with management plane.
 */
