...
#define DEV_MON_CMD_OUT_BAND_GET_UB_PORT_STATISTIC_INFO    0xA9
#define DEV_MON_CMD_OUT_BAND_GET_UB_PORT_LINK_INFO         0xAA
#define DEV_MON_CMD_OUT_BAND_NETWORK_LIGHT_CONTROL         0xAB
#define DEV_MON_CMD_OUT_BAND_GET_UB_PORT_INFO              0xB7
...
#define DEV_MON_CMD_GET_CUSTOM_OP_SECVERIFY_CERT           0xB6
#define DEV_MON_CMD_D_GET_ATTEST_EVIDENCE                  0xB8
#define DEV_MON_CMD_D_GET_AKCERT                           0xB9
#define DEV_MON_CMD_OUT_BAND_GET_PORT_STATS                0xBA
#define DEV_MON_CMD_OUT_BAND_GET_PROTOCOL_MAC_INFO         0xBB
#define DEV_MON_CMD_SET_OPTICAL_DIRTY_DETECTION            0xBD
#define DEV_MON_CMD_GET_PCIE_INFO                          0xBE
