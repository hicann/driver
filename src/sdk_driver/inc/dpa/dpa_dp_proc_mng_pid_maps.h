...
typedef int (*query_process_by_host_pid_kernel_func)(unsigned int host_pid, unsigned int chip_id,
                                                     enum devdrv_process_type cp_type, unsigned int vfid, int *pid);
typedef int (*query_process_by_host_pid_func)(unsigned int host_pid, unsigned int chip_id,
                                              enum devdrv_process_type cp_type, unsigned int vfid, int *pid);
...
typedef int (*query_master_info_by_slave_func)(int slave_tgid, int *master_tgid, u32 *udevid, int *mode,
