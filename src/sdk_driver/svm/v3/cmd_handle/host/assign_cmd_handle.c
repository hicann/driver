...
{
    svm_register_ioctl_cmd_post_handle(_KA_IOC_NR(SVM_MPL_POPULATE), cmd_mpl_populate_post_handle);
    svm_register_ioctl_cmd_pre_handle(_KA_IOC_NR(SVM_MPL_POPULATE), cmd_mpl_populate_pre_handle);
    svm_register_ioctl_cmd_pre_cancle_handle(_KA_IOC_NR(SVM_MPL_POPULATE), cmd_mpl_populate_pre_cancle_handle);
    svm_register_ioctl_cmd_pre_handle(_KA_IOC_NR(SVM_MPL_DEPOPULATE), cmd_mpl_depopulate_pre_handle);
}