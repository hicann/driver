...
static int devmm_ipc_vmmas_occupy_inc(struct devmm_svm_process *svm_proc, bool is_reserve_addr, u64 va, u64 size)
{
...
static void devmm_ipc_vmmas_occupy_dec(struct devmm_svm_process *svm_proc, bool is_reserve_addr, u64 va, u64 size)
{
    struct devmm_svm_heap *heap = NULL;
...
static int (*devmm_ipc_set_attr_handlers[SHMEM_ATTR_TYPE_MAX])(const char *name, uint64_t flag) = {
...
static int (*devmm_ipc_get_attr_handlers[SHMEM_ATTR_TYPE_MAX])(const char *name, uint64_t *flag) = {
