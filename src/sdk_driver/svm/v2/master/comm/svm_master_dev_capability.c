...
int devmm_set_dev_capability(const u32 did, const u32 vfid, struct devmm_chan_exchange_pginfo *info)
{
    ...
    devmm_drv_info(
        ...
        devmm_svm->dev_capability[did].feature_phycial_address, devmm_svm->dev_capability[did].feature_pcie_th,
        devmm_svm->dev_capability[did].feature_bar_mem, devmm_svm->dev_capability[did].dvpp_memsize,
        devmm_svm->dev_capability[did].svm_offset_num, devmm_svm->dev_capability[did].feature_dev_read_only,
        devmm_svm->dev_capability[did].feature_pcie_dma_support_sva,
        devmm_svm->dev_capability[did].feature_dev_mem_map_host, devmm_svm->dev_capability[did].feature_bar_huge_mem,
        devmm_svm->dev_capability[did].double_pgtable_offset, devmm_svm->dev_capability[did].feature_giant_page,
        devmm_svm->dev_capability[did].feature_remote_mmap, devmm_svm->dev_capability[did].feature_shmem_repair,
        devmm_svm->dev_capability[did].feature_mem_host_uva, devmm_svm->dev_capability[did].feature_host_mem_map_cap);
    return 0;
}
