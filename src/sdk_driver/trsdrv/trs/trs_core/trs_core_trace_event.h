...
KA_DFX_TRACE_EVENT(
    ...
    KA_DFX_TP_printk("%s:\t"
                     ...
                     __ka_entry->cq_trace.logic_cqid, __ka_entry->cq_trace.head, __ka_entry->cq_trace.tail,
                     __ka_entry->cq_trace.task_id, __ka_entry->cq_trace.stream_id, __ka_entry->cq_trace.sqid,
                     __ka_entry->cq_trace.sq_head, __ka_entry->cq_trace.sqe_type, __ka_entry->cq_trace.match_flag,
...
KA_DFX_TRACE_EVENT(logic_cq_recv,
                   KA_DFX_TP_PROTO(const char *str, struct trs_id_inst *inst,
                   ...
                   KA_DFX_TP_printk("%s:\t"
                                    ...
                                    "%lld.%06ld",
                                    __ka_dfx_get_str(str), __ka_entry->inst.devid, __ka_entry->inst.tsid,
                                    __ka_entry->recv_trace.logic_cqid, __ka_entry->recv_trace.report_cqe_num,
