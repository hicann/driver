...
ADD_FEATURE_COMMAND(DMS_MODULE_TRS_RPC_CTRL, DMS_GET_SET_DEVICE_INFO_CMD, ZERO_CMD, "main_cmd=0xb,sub_cmd=0xb", NULL,
                    DMS_ACC_ROOT_ONLY | DMS_ENV_NOT_NORMAL_DOCKER | DMS_VDEV_NOTSUPPORT, trs_urd_rpc_msg_set)
ADD_FEATURE_COMMAND(DMS_MODULE_TRS_RPC_CTRL, DMS_GET_GET_DEVICE_INFO_CMD, ZERO_CMD, "main_cmd=0xb,sub_cmd=0xb", NULL,
