...
typedef union {
    ...
    struct {
         ...
         * 4'd4: The slot_ENABLE sends the enable signal and configuration information to the corresponding ACSQ to
         * establish the mapping. 4'd5: WORKING 4'd6: Wait_SWAPOUT waits for the busy signal corresponding to the
         * prefetch_buffer to pull down. 4'd7: The slot_DISABLE is used to disassociate acsq. 4'd8: SQCQ_ASYNC_REQ
         * indicates that a software operation occurs and the software operation information is synchronized to the
         * acsq. 4'd9:Wait_FW_RSP waiting for software operation 4'dA:Polling_FLAG rtsq waiting for task synchronization
