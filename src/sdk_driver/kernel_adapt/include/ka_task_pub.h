...
#define ka_task_wait_for_completion_interruptible_timeout(x, timeout) \
...
#define ka_task_autoremove_wake_function(wq_entry, mode, sync, key) autoremove_wake_function(wq_entry, mode, sync, key)
...
#define ka_task_wait_event_interruptible_exclusive(wq, condition) wait_event_interruptible_exclusive(wq, condition)
#define ka_task_wait_event_interruptible_timeout(wq_head, condition, timeout) \
    wait_event_interruptible_timeout(wq_head, condition, timeout)

#define ka_task_wait_event_timeout(wq_head, condition, timeout) wait_event_timeout(wq_head, condition, timeout)

#define ka_task_wait_event_interruptible(wq_head, condition) wait_event_interruptible(wq_head, condition)
