...
DEFINE_DATA_MODEL(IMP_LOG);
DEFINE_DATA_MODEL(IMU_LOG);
...
struct bbox_plaintext_table_map g_plaintext_table_map[] = {
    ...
    {PLAINTEXT_TABLE_IMU_LOG,                       MODEL_VECTOR_SIZE(IMU_LOG),
        MODEL_VECTOR_OBJECT(IMU_LOG),                   BBOX_FILE_NAME_IMU_LOG},
    {PLAINTEXT_TABLE_IMP_LOG,                       MODEL_VECTOR_SIZE(IMP_LOG),
        MODEL_VECTOR_OBJECT(IMP_LOG),                   BBOX_FILE_NAME_IMP_LOG},
