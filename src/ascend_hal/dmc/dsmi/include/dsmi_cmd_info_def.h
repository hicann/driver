...
DSMI_CMD_DEF_DAVINCI_INSTANCE(DEV_MON_CMD_QUERY_ECC_INFO_V2, (sizeof(int) + sizeof(int)),
    sizeof(struct dsmi_ecc_info_stru), STATE_MANAGE_TYPE)
DSMI_CMD_DEF_DAVINCI_INSTANCE(DEV_MON_CMD_D_GET_FREQUENCY_V2, (sizeof(int) + sizeof(int)),
    sizeof(unsigned int), STATE_MANAGE_TYPE)
