...
typedef enum tagdrvErrorCode_t {
    ...
    DRV_ERRCOED_INVALID_ARGUMENT_WITH_PARAM = 16,
    DRV_ERRCODE_INVALID_ARGUMENT_NULL_POINTER = 17,
    DRV_ERRCOED_INSUFFICIENT_HOST_MEMORY = 18,
    DRV_ERRCODE_INSUFFICIENT_DEVICE_MEMORY = 19,
    DRV_ERRCODE_DEVICE_BUSY = 20,
    DRV_ERRCODE_OPERATION_NOT_SUPPORT = 21,
    DRV_ERRCODE_INSUFFICIENT_SQCQ = 22,
...
static const int32_t g_error_code_map[] = {
    ...
    [DRV_ERROR_NOT_EXIST] = DRV_ERRCOED_INNER,
    ...
    [DRV_ERROR_WAIT_TIMEOUT] = DRV_ERRCOED_INNER,
    ...
    [DRV_ERROR_NO_PROCESS] = DRV_ERRCOED_INNER,
    ...
    [DRV_ERROR_QUEUE_EMPTY] = DRV_ERRCOED_INNER,
