...
{
    return (uint32)(sizeof(struct uni_buff_head_t) + sizeof(struct share_mbuf) + mbuf_get_align_size() +
...
{
    struct uni_buff_tail_t *tail = (struct uni_buff_tail_t *)((char *)head + head->size -
                                                              sizeof(struct uni_buff_tail_t));
    drvError_t ret;
