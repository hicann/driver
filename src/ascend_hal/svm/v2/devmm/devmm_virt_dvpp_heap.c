...
STATIC struct devmm_com_heap_ops g_dvpp_heap_op = {devmm_virt_heap_alloc_device, devmm_virt_heap_free_pages};

static void devmm_fill_dvpp_heap_info(struct devmm_virt_heap_mgmt *mgmt, struct devmm_virt_heap_type *heap_type,
