...
#ifndef UVM_OPEN
    struct devmm_virt_com_heap uvm_heap; /* use for manage UVM 4T heap */
#endif
    struct devmm_virt_com_heap soma_heap; /* use for manage SOMA 3T heap */
...
#ifndef UVM_OPEN
    virt_addr_t uvm_start; /* uvm vaddr start */
    virt_addr_t uvm_end;   /* uvm vaddr end */
#endif
