...
enum mem_register_src_side { HOST_MEM_REGISTER = 0, DEV_MEM_REGISTER, MEM_REGISTER_MAX_SIDE };
...
enum register_record_tree_type { NO_DMA_MAP_RECORD_TREE = 0, DMA_MAP_RECORD_TREE, RECORD_TREE_MAX_TYPE };
