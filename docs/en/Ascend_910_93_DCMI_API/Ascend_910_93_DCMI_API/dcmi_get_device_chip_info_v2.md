# dcmi\_get\_device\_chip\_info\_v2<a name="EN-US_TOPIC_0000002515510488"></a>

**Prototype<a name="section1977653135210"></a>**

**int dcmi\_get\_device\_chip\_info\_v2\(int card\_id, int device\_id, struct dcmi\_chip\_info\_v2 \*chip\_info\)**

**Description<a name="section997810532524"></a>**

Obtains the  **dcmi\_chip\_info\_v2**  information of an NPU, MCU, and CPU, including  **chip\_name**,  **chip\_ver**,  **aicore\_cnt**, and  **npu\_name**.

**Parameter Description<a name="section7979185317526"></a>**

<a name="table536115411529"></a>
<table><thead align="left"><tr id="row1143155419520"><th class="cellrowborder" valign="top" width="14.291429142914291%" id="mcps1.1.5.1.1"><p id="p51432545520"><a name="p51432545520"></a><a name="p51432545520"></a>Parameter</p>
</th>
<th class="cellrowborder" valign="top" width="12.241224122412241%" id="mcps1.1.5.1.2"><p id="p141431454155216"><a name="p141431454155216"></a><a name="p141431454155216"></a>Input/Output</p>
</th>
<th class="cellrowborder" valign="top" width="12.241224122412241%" id="mcps1.1.5.1.3"><p id="p7143115425218"><a name="p7143115425218"></a><a name="p7143115425218"></a>Type</p>
</th>
<th class="cellrowborder" valign="top" width="61.22612261226122%" id="mcps1.1.5.1.4"><p id="p11143125419524"><a name="p11143125419524"></a><a name="p11143125419524"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="12.241224122412241%" headers="mcps1.1.5.1.2 "><p id="p2014318546527"><a name="p2014318546527"></a><a name="p2014318546527"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="61.22612261226122%" headers="mcps1.1.5.1.4 "><p id="p01431954195214"><a name="p01431954195214"></a><a name="p01431954195214"></a>Device ID. The supported IDs can be obtained by calling <strong id="b22151900181438"><a name="b22151900181438"></a><a name="b22151900181438"></a>dcmi_get_card_list</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="12.241224122412241%" headers="mcps1.1.5.1.2 "><p id="p17143854155215"><a name="p17143854155215"></a><a name="p17143854155215"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="61.22612261226122%" headers="mcps1.1.5.1.4 "><p id="p18144175405218"><a name="p18144175405218"></a><a name="p18144175405218"></a>Chip ID, which can be obtained by calling <strong id="b141580059333051"><a name="b141580059333051"></a><a name="b141580059333051"></a>dcmi_get_device_id_in_card</strong>. Value range:</p>
<p id="p814475411523"><a name="p814475411523"></a><a name="p814475411523"></a>NPU: [0, <strong id="b115212730494127"><a name="b115212730494127"></a><a name="b115212730494127"></a>device_id_max</strong> – 1]</p>
...
<td class="cellrowborder" valign="top" width="12.241224122412241%" headers="mcps1.1.5.1.2 "><p id="p17144165485210"><a name="p17144165485210"></a><a name="p17144165485210"></a>Output</p>
</td>
...
<td class="cellrowborder" valign="top" width="61.22612261226122%" headers="mcps1.1.5.1.4 "><p id="p1714419542520"><a name="p1714419542520"></a><a name="p1714419542520"></a><strong id="b682161519282"><a name="b682161519282"></a><a name="b682161519282"></a>chip_info</strong> information, including <strong id="b18216153288"><a name="b18216153288"></a><a name="b18216153288"></a>chip_name</strong>, <strong id="b14821151552816"><a name="b14821151552816"></a><a name="b14821151552816"></a>chip_ver</strong>, <strong id="b58219154289"><a name="b58219154289"></a><a name="b58219154289"></a>aicore_cnt</strong>, and <strong id="b138211615162814"><a name="b138211615162814"></a><a name="b138211615162814"></a>npu_name</strong>.</p>
<p id="p41444544524"><a name="p41444544524"></a><a name="p41444544524"></a>struct dcmi_chip_info_v2 {</p>
<p id="p11144205414526"><a name="p11144205414526"></a><a name="p11144205414526"></a>unsigned char chip_type[MAX_CHIP_NAME_LEN];// Chip type</p>
<p id="p1714455412520"><a name="p1714455412520"></a><a name="p1714455412520"></a>unsigned char chip_name[MAX_CHIP_NAME_LEN];// Chip name</p>
<p id="p714510547525"><a name="p714510547525"></a><a name="p714510547525"></a>unsigned char chip_ver[MAX_CHIP_NAME_LEN];// Chip version number</p>
<p id="p1414555485211"><a name="p1414555485211"></a><a name="p1414555485211"></a>unsigned int aicore_cnt;// Number of AI Cores</p>
<p id="p14145165435217"><a name="p14145165435217"></a><a name="p14145165435217"></a>unsigned char npu_name[MAX_CHIP_NAME_LEN];// NPU model on the module</p>
...
**Return Value<a name="section15342615175411"></a>**
...
<a name="en-us_topic_0000001917887173_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"></a><a name="en-us_topic_0000001917887173_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"></a><ul id="en-us_topic_0000001917887173_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"><li>Success: The value <strong id="b180954786472311"><a name="b180954786472311"></a><a name="b180954786472311"></a>0</strong> is returned.</li><li>Failure: For details about the return codes, see <a href="return-codes.md">Return Codes</a>.</li></ul>
</td>
</tr>
</tbody>
</table>
...
**Example<a name="section029115405211"></a>**
