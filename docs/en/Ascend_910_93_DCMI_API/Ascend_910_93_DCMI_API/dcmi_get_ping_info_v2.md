# dcmi\_get\_ping\_info\_v2<a name="EN-US_TOPIC_0000002546990355"></a>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p192301855143912"><a name="p192301855143912"></a><a name="p192301855143912"></a>Device ID. The supported IDs can be obtained by calling <strong id="b211437370781749"><a name="b211437370781749"></a><a name="b211437370781749"></a>dcmi_get_card_list</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p1423015555395"><a name="p1423015555395"></a><a name="p1423015555395"></a>Chip ID, which can be obtained by calling <strong id="b57961419433041"><a name="b57961419433041"></a><a name="b57961419433041"></a>dcmi_get_device_id_in_card</strong>. Value range:</p>
<p id="p11230125511398"><a name="p11230125511398"></a><a name="p11230125511398"></a>NPU: [0, <strong id="b20018349481749"><a name="b20018349481749"></a><a name="b20018349481749"></a>device_id_max</strong> – 1]</p>
<p id="p723015512391"><a name="p723015512391"></a><a name="p723015512391"></a>MCU: <strong id="b144875738581749"><a name="b144875738581749"></a><a name="b144875738581749"></a>mcu_id</strong></p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p82316551391"><a name="p82316551391"></a><a name="p82316551391"></a>Network port number of the NPU device. Currently, the value can only be set to <strong id="b66521350581749"><a name="b66521350581749"></a><a name="b66521350581749"></a>0</strong>.</p>
</td>
</tr>
...
<p id="p182311355123911"><a name="p182311355123911"></a><a name="p182311355123911"></a>char dst_addr[IP_ADDR_LEN];// Destination IPv4 address of the device to be pinged. The value of <strong id="b103746473981749"><a name="b103746473981749"></a><a name="b103746473981749"></a>IP_ADDR_LEN</strong> is <strong id="b34263950081749"><a name="b34263950081749"></a><a name="b34263950081749"></a>16</strong>.</p>
<p id="p1123112551393"><a name="p1123112551393"></a><a name="p1123112551393"></a>unsigned int sdid;// SDID of the device to be pinged. Either <strong id="b28985042881749"><a name="b28985042881749"></a><a name="b28985042881749"></a>sdid</strong> or <strong id="b155303625981749"><a name="b155303625981749"></a><a name="b155303625981749"></a>dst_addr</strong> is used to configure the destination address. If both of them are configured, <strong id="b60272286781749"><a name="b60272286781749"></a><a name="b60272286781749"></a>dst_addr</strong> is used.</p>
<p id="p18231655203917"><a name="p18231655203917"></a><a name="p18231655203917"></a>unsigned int packet_size;// Size of a ping packet. The value range is 1792 to 3000 bytes. The packet header size is 1024 bytes. The correctness of the subsequent 1025 bytes to the <strong id="b159287497081749"><a name="b159287497081749"></a><a name="b159287497081749"></a>packet_size</strong> field is verified. The field type distribution of every 1024 bytes is as follows: 0xFF (256 bytes), 0x00 (256 bytes), 0xAA (256 bytes), and 0x55 (256 bytes).</p>
...
<p id="p1223185553919"><a name="p1223185553919"></a><a name="p1223185553919"></a>unsigned int packet_interval;// Delay interval for sending ping packets. The value ranges from 0 to 10 ms. The value <strong id="b90629496781749"><a name="b90629496781749"></a><a name="b90629496781749"></a>0</strong> indicates that a packet is sent immediately after a response is received.</p>
...
<p id="p956221181420"><a name="p956221181420"></a><a name="p956221181420"></a>In versions earlier than 25.0.RC1, the restrictions on using the preceding parameters are as follows:</p>
...
<p id="p42321755193919"><a name="p42321755193919"></a><a name="p42321755193919"></a>enum dcmi_ping_result ret[DCMI_PING_PACKET_NUM_MAX];// Ping result of each data packet. The enumerated values of <strong id="b114884599681749"><a name="b114884599681749"></a><a name="b114884599681749"></a>dcmi_ping_result</strong> include <strong id="b59545051181749"><a name="b59545051181749"></a><a name="b59545051181749"></a>0</strong> (ping operation not initiated), <strong id="b99974351681749"><a name="b99974351681749"></a><a name="b99974351681749"></a>1</strong> (ping packet successfully sent and received), <strong id="b166613299781749"><a name="b166613299781749"></a><a name="b166613299781749"></a>2</strong> (packet sending failure), and <strong id="b174903587181749"><a name="b174903587181749"></a><a name="b174903587181749"></a>3</strong> (packet reception failure). The value of <strong id="b108358358881749"><a name="b108358358881749"></a><a name="b108358358881749"></a>DCMI_PING_PACKET_NUM_MAX</strong> is <strong id="b188442701081749"><a name="b188442701081749"></a><a name="b188442701081749"></a>1000</strong>.</p>
...
<p id="p144359591598"><a name="p144359591598"></a><a name="p144359591598"></a>unsigned char L1_plane_check_res [DCMI_PING_PACKET_NUM_MAX];// L1 plane where data reception failed during each ping attempt</p>
<p id="p124351659392"><a name="p124351659392"></a><a name="p124351659392"></a>unsigned char reserved[DCMI_PING_PACKET_NUM_MAX];// Reserved</p>
...
<a name="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"></a><a name="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"></a><ul id="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"><li>Success: The value <strong id="b144829379381749"><a name="b144829379381749"></a><a name="b144829379381749"></a>0</strong> is returned.</li><li>Failure: For details about the return codes, see <a href="return-codes.md">Return Codes</a>.</li></ul>
</td>
</tr>
</tbody>
</table>
