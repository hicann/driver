# dcmi\_get\_spod\_node\_status<a name="EN-US_TOPIC_0000002515350572"></a>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p12751627153211"><a name="p12751627153211"></a><a name="p12751627153211"></a>Device ID. The supported IDs can be obtained by calling <strong id="b31766666233144"><a name="b31766666233144"></a><a name="b31766666233144"></a>dcmi_get_card_num_list</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p075152718324"><a name="p075152718324"></a><a name="p075152718324"></a>Chip ID, which can be obtained by calling <strong id="b13617806403312"><a name="b13617806403312"></a><a name="b13617806403312"></a>dcmi_get_device_id_in_card</strong>. Value range:</p>
<p id="p875116277323"><a name="p875116277323"></a><a name="p875116277323"></a>NPU: [0, <strong id="b84631311781434"><a name="b84631311781434"></a><a name="b84631311781434"></a>device_id_max</strong> – 1]</p>
...
<td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.2 "><p id="p127518275328"><a name="p127518275328"></a><a name="p127518275328"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p27511627163218"><a name="p27511627163218"></a><a name="p27511627163218"></a>Indicates the unique ID of each NPU in the SuperPoD system. The SDID of a target NPU should be provided.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.2 "><p id="p47511527183220"><a name="p47511527183220"></a><a name="p47511527183220"></a>Output</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p275162733218"><a name="p275162733218"></a><a name="p275162733218"></a>Indicates the status information about the NPU identified by SDID. The default value is <strong id="b12342202116166"><a name="b12342202116166"></a><a name="b12342202116166"></a>0</strong>.</p>
