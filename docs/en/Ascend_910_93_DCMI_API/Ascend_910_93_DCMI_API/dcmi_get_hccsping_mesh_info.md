# dcmi\_get\_hccsping\_mesh\_info<a name="EN-US_TOPIC_0000002515350530"></a>
...
<td class="cellrowborder" valign="top" width="50.29%" headers="mcps1.1.5.1.4 "><p id="p128787249495"><a name="p128787249495"></a><a name="p128787249495"></a>Device ID. The supported IDs can be obtained by calling <strong id="b169132521481550"><a name="b169132521481550"></a><a name="b169132521481550"></a>dcmi_get_card_list</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.29%" headers="mcps1.1.5.1.4 "><p id="p187872444910"><a name="p187872444910"></a><a name="p187872444910"></a>Chip ID, which can be obtained by calling <strong id="b61707094733054"><a name="b61707094733054"></a><a name="b61707094733054"></a>dcmi_get_device_id_in_card</strong>. Value range:</p>
<p id="p687882424914"><a name="p687882424914"></a><a name="p687882424914"></a>NPU: [0, <strong id="b6008105342550"><a name="b6008105342550"></a><a name="b6008105342550"></a>device_id_max</strong> – 1]</p>
...
<td class="cellrowborder" valign="top" width="50.29%" headers="mcps1.1.5.1.4 "><p id="p18879624114919"><a name="p18879624114919"></a><a name="p18879624114919"></a>(Reserved) Network port number of the NPU device. Currently, the value can only be set to <strong id="b137316111433449"><a name="b137316111433449"></a><a name="b137316111433449"></a>0</strong>.</p>
</td>
</tr>
...
<div class="note" id="note8393718184"><a name="note8393718184"></a><a name="note8393718184"></a><span class="notetitle"> NOTE: </span><div class="notebody"><a name="ul97018984016"></a><a name="ul97018984016"></a><ul id="ul97018984016"><li>In the output structure, the index in <strong id="b13867881013"><a name="b13867881013"></a><a name="b13867881013"></a>dst_addr</strong> for a destination address is the same as the index in each result of pinging that address in each array. For example, for the destination address <strong id="b12325161012111"><a name="b12325161012111"></a><a name="b12325161012111"></a>dst_addr[0]</strong>, the number of successful ping operations is <strong id="b1232581011114"><a name="b1232581011114"></a><a name="b1232581011114"></a>suc_pkt_num[0]</strong>, the number of ping failures is <strong id="b20325610914"><a name="b20325610914"></a><a name="b20325610914"></a>fail_pkt_num[0]</strong>, and so on.</li><li>If the values of <strong id="b446611182011"><a name="b446611182011"></a><a name="b446611182011"></a>max_time</strong>, <strong id="b1324720112"><a name="b1324720112"></a><a name="b1324720112"></a>min_time</strong>, <strong id="b1479116222116"><a name="b1479116222116"></a><a name="b1479116222116"></a>avg_time</strong> and <strong id="b11180122518113"><a name="b11180122518113"></a><a name="b11180122518113"></a>tp95_time</strong> are -1, the corresponding destination address is not pinged.</li></ul>
</div></div>
</td>
</tr>
</tbody>
...
<a name="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"></a><a name="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"></a><ul id="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"><li>Success: The value <strong id="b84879429472314"><a name="b84879429472314"></a><a name="b84879429472314"></a>0</strong> is returned.</li><li>Failure: For details about the return codes, see <a href="return-codes.md">Return Codes</a>.</li></ul>
</td>
</tr>
</tbody>
</table>
