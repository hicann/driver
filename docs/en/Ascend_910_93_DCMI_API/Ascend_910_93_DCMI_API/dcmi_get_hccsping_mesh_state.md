# dcmi\_get\_hccsping\_mesh\_state<a name="EN-US_TOPIC_0000002515510526"></a>

**Prototype<a name="section16702412497"></a>**

**int dcmi\_get\_hccsping\_mesh\_state \(int card\_id, int device\_id, int port\_id, unsigned int task\_id, unsigned int \*state\)**

**Description<a name="section87015415495"></a>**

Queries the status of a resident pingmesh task.

**Parameter Description<a name="section2703414496"></a>**

<a name="table9922411492"></a>
<table><thead align="left"><tr id="row0150341164913"><th class="cellrowborder" valign="top" width="17.169999999999998%" id="mcps1.1.5.1.1"><p id="p1315044114491"><a name="p1315044114491"></a><a name="p1315044114491"></a>Parameter</p>
</th>
<th class="cellrowborder" valign="top" width="15.15%" id="mcps1.1.5.1.2"><p id="p415010410495"><a name="p415010410495"></a><a name="p415010410495"></a>Input/Output</p>
</th>
<th class="cellrowborder" valign="top" width="17.169999999999998%" id="mcps1.1.5.1.3"><p id="p2150541164920"><a name="p2150541164920"></a><a name="p2150541164920"></a>Type</p>
</th>
<th class="cellrowborder" valign="top" width="50.51%" id="mcps1.1.5.1.4"><p id="p1515011417498"><a name="p1515011417498"></a><a name="p1515011417498"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="p3150174174914"><a name="p3150174174914"></a><a name="p3150174174914"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="p8150541184913"><a name="p8150541184913"></a><a name="p8150541184913"></a>Device ID. The supported IDs can be obtained by calling <strong id="b137459253633050"><a name="b137459253633050"></a><a name="b137459253633050"></a>dcmi_get_card_list</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="p3151104120494"><a name="p3151104120494"></a><a name="p3151104120494"></a>Chip ID, which can be obtained by calling <strong id="b132660334381544"><a name="b132660334381544"></a><a name="b132660334381544"></a>dcmi_get_device_id_in_card</strong>. Value range:</p>
<p id="p1151541164917"><a name="p1151541164917"></a><a name="p1151541164917"></a>NPU: [0, <strong id="b17812363222551"><a name="b17812363222551"></a><a name="b17812363222551"></a>device_id_max</strong> – 1]</p>
...
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="p1015164114497"><a name="p1015164114497"></a><a name="p1015164114497"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="p515174114914"><a name="p515174114914"></a><a name="p515174114914"></a>(Reserved) Network port number of the NPU device. Currently, the value can only be set to <strong id="b60224704933450"><a name="b60224704933450"></a><a name="b60224704933450"></a>0</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="p2015194114496"><a name="p2015194114496"></a><a name="p2015194114496"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="p41511941154910"><a name="p41511941154910"></a><a name="p41511941154910"></a><strong id="b1437016329507"><a name="b1437016329507"></a><a name="b1437016329507"></a>task_id</strong>: task ID. The value range is [0, 1], which is specified by <strong id="b159111433135013"><a name="b159111433135013"></a><a name="b159111433135013"></a>dcmi_start_hccsping_mesh</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="p215114114910"><a name="p215114114910"></a><a name="p215114114910"></a>Output</p>
</td>
...
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="p19151114117492"><a name="p19151114117492"></a><a name="p19151114117492"></a>Status of a resident pingmesh task.</p>
<p id="p191511741174916"><a name="p191511741174916"></a><a name="p191511741174916"></a><strong id="b488183785013"><a name="b488183785013"></a><a name="b488183785013"></a>0</strong>: The resident task is stopped.</p>
<p id="p15152141204919"><a name="p15152141204919"></a><a name="p15152141204919"></a><strong id="b1982119388502"><a name="b1982119388502"></a><a name="b1982119388502"></a>1</strong>: The resident task is running.</p>
</td>
</tr>
</tbody>
</table>

**Return Value<a name="section2819411496"></a>**
...
<a name="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"></a><a name="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"></a><ul id="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"><li>Success: The value <strong id="b118216912172316"><a name="b118216912172316"></a><a name="b118216912172316"></a>0</strong> is returned.</li><li>Failure: For details about the return codes, see <a href="return-codes.md">Return Codes</a>.</li></ul>
</td>
</tr>
</tbody>
</table>

**Exception Handling<a name="section188654110499"></a>**

None

**Restrictions<a name="section787141184917"></a>**
...
**Example<a name="section14902041154916"></a>**
