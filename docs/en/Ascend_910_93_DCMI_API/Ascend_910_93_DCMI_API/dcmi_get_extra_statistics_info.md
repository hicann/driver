# dcmi\_get\_extra\_statistics\_info<a name="EN-US_TOPIC_0000002546910353"></a>

**Prototype<a name="section429221610582"></a>**
...
**Description<a name="section102929165586"></a>**
...
**Parameter Description<a name="section929351605810"></a>**

<a name="table18308181615816"></a>
<table><thead align="left"><tr id="row1134310167588"><th class="cellrowborder" valign="top" width="17.169999999999998%" id="mcps1.1.5.1.1"><p id="p143431616195810"><a name="p143431616195810"></a><a name="p143431616195810"></a>Parameter</p>
</th>
<th class="cellrowborder" valign="top" width="15.15%" id="mcps1.1.5.1.2"><p id="p134391615810"><a name="p134391615810"></a><a name="p134391615810"></a>Input/Output</p>
</th>
<th class="cellrowborder" valign="top" width="17.169999999999998%" id="mcps1.1.5.1.3"><p id="p13343101635816"><a name="p13343101635816"></a><a name="p13343101635816"></a>Type</p>
</th>
<th class="cellrowborder" valign="top" width="50.51%" id="mcps1.1.5.1.4"><p id="p7343111612584"><a name="p7343111612584"></a><a name="p7343111612584"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="p934317169586"><a name="p934317169586"></a><a name="p934317169586"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="p33431716105818"><a name="p33431716105818"></a><a name="p33431716105818"></a>Device ID. The supported IDs can be obtained by calling <strong id="b131190080181325"><a name="b131190080181325"></a><a name="b131190080181325"></a>dcmi_get_card_list</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="p0343161610582"><a name="p0343161610582"></a><a name="p0343161610582"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="p173432016105817"><a name="p173432016105817"></a><a name="p173432016105817"></a>Chip ID, which can be obtained by calling <strong id="b102911298733052"><a name="b102911298733052"></a><a name="b102911298733052"></a>dcmi_get_device_id_in_card</strong>. Value range:</p>
<p id="p1534331611582"><a name="p1534331611582"></a><a name="p1534331611582"></a>NPU: [0, <strong id="b45252699625458"><a name="b45252699625458"></a><a name="b45252699625458"></a>device_id_max</strong> – 1]</p>
...
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="p13444161584"><a name="p13444161584"></a><a name="p13444161584"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="p9359145314538"><a name="p9359145314538"></a><a name="p9359145314538"></a>Network port number of the NPU device. Currently, the value can only be set to <strong id="b124434779524810"><a name="b124434779524810"></a><a name="b124434779524810"></a>0</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="p934481611585"><a name="p934481611585"></a><a name="p934481611585"></a>Output</p>
</td>
...
<p id="p1691522111155"><a name="p1691522111155"></a><a name="p1691522111155"></a>unsigned long long cw_total_cnt; // Total number of codewords</p>
<p id="p3915172171510"><a name="p3915172171510"></a><a name="p3915172171510"></a>unsigned long long cw_before_correct_cnt; // Forward error correction codewords</p>
<p id="p9915122181510"><a name="p9915122181510"></a><a name="p9915122181510"></a>unsigned long long cw_correct_cnt; // Correctable codeword errors</p>
<p id="p119151621151518"><a name="p119151621151518"></a><a name="p119151621151518"></a>unsigned long long cw_uncorrect_cnt; // Uncorrectable codeword errors</p>
<p id="p191592116158"><a name="p191592116158"></a><a name="p191592116158"></a>unsigned long long cw_bad_cnt; // Number of cw_bad events</p>
<p id="p1791562113150"><a name="p1791562113150"></a><a name="p1791562113150"></a>unsigned long long trans_total_bit; // Total number of transmitted bits</p>
<p id="p391582171510"><a name="p391582171510"></a><a name="p391582171510"></a>unsigned long long cw_total_correct_bit; // Total number of correctable bits in codewords</p>
<p id="p291512191519"><a name="p291512191519"></a><a name="p291512191519"></a>unsigned long long rx_full_drop_cnt; // Number of discarded packets after buffer in the RX direction is full</p>
<p id="p17916122113159"><a name="p17916122113159"></a><a name="p17916122113159"></a>unsigned long long pcs_err_cnt; // Number of error blocks at the PCS layer</p>
<p id="p149165218158"><a name="p149165218158"></a><a name="p149165218158"></a>unsigned long long rx_send_app_good_pkts; // Total number of good frames sent to the application side, excluding <strong id="b1580110582324"><a name="b1580110582324"></a><a name="b1580110582324"></a>fc-consumed-error</strong> frames. <strong id="b1824395314323"><a name="b1824395314323"></a><a name="b1824395314323"></a>fc-consumed-error</strong> indicates flow control frames flagged as <strong id="b824312536328"><a name="b824312536328"></a><a name="b824312536328"></a>abort</strong> by the MAC layer</p>
<p id="p5916821121518"><a name="p5916821121518"></a><a name="p5916821121518"></a>unsigned long long rx_send_app_bad_pkts; // Total number of bad frames or <strong id="b12837817153312"><a name="b12837817153312"></a><a name="b12837817153312"></a>fc-consumed-error</strong> frames sent to the application side</p>
<p id="p18916122141519"><a name="p18916122141519"></a><a name="p18916122141519"></a>double correcting_bit_rate; // Correctable bit error rate</p>
...
**Return Value<a name="section1303191625818"></a>**
...
<a name="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"></a><a name="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"></a><ul id="en-us_topic_0000001819869974_en-us_topic_0000001251227149_en-us_topic_0000001178213202_en-us_topic_0000001097675636_en-us_topic_0000001170223803_en-us_topic_0160151812_ul55711364478"><li>Success: The value <strong id="b108211044472312"><a name="b108211044472312"></a><a name="b108211044472312"></a>0</strong> is returned.</li><li>Failure: For details about the return codes, see <a href="return-codes.md">Return Codes</a>.</li></ul>
</td>
</tr>
</tbody>
</table>

**Exception Handling<a name="section1630512161584"></a>**

None

**Restrictions<a name="section73061816145810"></a>**
...
**Example<a name="section830781617583"></a>**
