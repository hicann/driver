# dcmiv2\_get\_device\_compatibility<a name="EN-US_TOPIC_0000002314045094"></a>
...
<p id="p115365533199"><a name="p115365533199"></a><a name="p115365533199"></a>DCMI_COMPAT_OK = 1, // The NPU driver is compatible with the NPU firmware.</p>
<p id="p453625319193"><a name="p453625319193"></a><a name="p453625319193"></a>DCMI_COMPAT_NOK = 2, // The NPU driver is incompatible with the NPU firmware.</p>
<p id="p145361553101913"><a name="p145361553101913"></a><a name="p145361553101913"></a>DCMI_COMPAT_UNKNOWN = 3 // The mapping between the NPU driver and NPU firmware is unknown.</p>
