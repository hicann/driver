# dcmiv2\_get\_device\_power\_info<a name="EN-US_TOPIC_0000002347924009"></a>

## Prototype<a name="en-us_topic_0000001251107225_en-us_topic_0000001177894708_en-us_topic_0000001101283718_toc533412077"></a>

**int dcmiv2\_get\_device\_power\_info\(int dev\_id, int \*power\_info\)**
...
int dev_id = 0;
int power_info = 0;
ret = dcmiv2_get_device_power_info(dev_id, &power_info);
...
```
