# dcmiv2\_get\_device\_list<a name="EN-US_TOPIC_0000002523945486"></a>

## Prototype<a name="en-us_topic_0000001251227173_en-us_topic_0000001223292889_en-us_topic_0000001147723703_toc533412077"></a>

**int dcmiv2\_get\_device\_list\(int \*device\_list, int \*device\_cnt, int list\_len\)**
...
<tr id="en-us_topic_0000001251227173_en-us_topic_0000001223292889_en-us_topic_0000001147723703_row15462171542913"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p9876144122716"><a name="p9876144122716"></a><a name="p9876144122716"></a>device_cnt</p>
</td>
...
<td class="cellrowborder" valign="top" width="16.009999999999998%" headers="mcps1.1.5.1.3 "><p id="p587610410275"><a name="p587610410275"></a><a name="p587610410275"></a>int<strong id="b19236424132317"><a name="b19236424132317"></a><a name="b19236424132317"></a> *</strong></p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p12875841275"><a name="p12875841275"></a><a name="p12875841275"></a>Number of devices. The maximum value is 64.</p>
</td>
</tr>
<tr id="row52481636124616"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p172499364468"><a name="p172499364468"></a><a name="p172499364468"></a>list_len</p>
</td>
<td class="cellrowborder" valign="top" width="16.99%" headers="mcps1.1.5.1.2 "><p id="p10249183616468"><a name="p10249183616468"></a><a name="p10249183616468"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="16.009999999999998%" headers="mcps1.1.5.1.3 "><p id="p924903619466"><a name="p924903619466"></a><a name="p924903619466"></a>int</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p324923612469"><a name="p324923612469"></a><a name="p324923612469"></a>Length of the <strong id="b13596193112710"><a name="b13596193112710"></a><a name="b13596193112710"></a>device_list</strong> array.</p>
</td>
</tr>
</tbody>
</table>
...
int device_cnt = 0;
ret = dcmiv2_get_device_list(device_list, &device_cnt, MAX_CARD_NUM);
...
```
