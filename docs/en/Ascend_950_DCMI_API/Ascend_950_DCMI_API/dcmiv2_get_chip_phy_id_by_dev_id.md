# dcmiv2\_get\_chip\_phy\_id\_by\_dev\_id<a name="EN-US_TOPIC_0000002347923969"></a>

## Prototype<a name="en-us_topic_0000001189111912_en-us_topic_0000001167913765_toc533412077"></a>

**int dcmiv2\_get\_chip\_phy\_id\_by\_dev\_id\(int dev\_id, unsigned int \*phyid\)**

## Description<a name="en-us_topic_0000001189111912_en-us_topic_0000001167913765_toc533412078"></a>

Obtains the physical chip ID based on the logical ID of the software.
...
<td class="cellrowborder" valign="top" width="16.06%" headers="mcps1.1.5.1.3 "><p id="en-us_topic_0000001189111912_p17454182115010"><a name="en-us_topic_0000001189111912_p17454182115010"></a><a name="en-us_topic_0000001189111912_p17454182115010"></a>unsigned int<strong id="b1394863910343"><a name="b1394863910343"></a><a name="b1394863910343"></a> *</strong></p>
</td>
...
ret = dcmiv2_get_chip_phy_id_by_dev_id(dev_id, &phyid);
if (ret != DCMI_OK) {
    printf("dcmiv2_get_chip_phy_id_by_dev_id failed. err is %d\n", ret);
}
return ret; 
...
```
