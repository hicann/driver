# dcmiv2\_get\_dev\_id\_by\_chip\_phy\_id<a name="EN-US_TOPIC_0000002314045102"></a>

## Prototype<a name="en-us_topic_0000001189111912_en-us_topic_0000001167913765_toc533412077"></a>

**int dcmiv2\_get\_dev\_id\_by\_chip\_phy\_id\(int phyid, unsigned int \*dev\_id\)**

## Description<a name="en-us_topic_0000001189111912_en-us_topic_0000001167913765_toc533412078"></a>

Obtains the logical ID of the software based on the physical chip ID.
...
<th class="cellrowborder" valign="top" width="16.04%" id="mcps1.1.5.1.3"><p id="en-us_topic_0000001189111912_en-us_topic_0000001167913765_p54045009"><a name="en-us_topic_0000001189111912_en-us_topic_0000001167913765_p54045009"></a><a name="en-us_topic_0000001189111912_en-us_topic_0000001167913765_p54045009"></a>Type</p>
</th>
<th class="cellrowborder" valign="top" width="54.39000000000001%" id="mcps1.1.5.1.4"><p id="en-us_topic_0000001189111912_en-us_topic_0000001167913765_p15569626"><a name="en-us_topic_0000001189111912_en-us_topic_0000001167913765_p15569626"></a><a name="en-us_topic_0000001189111912_en-us_topic_0000001167913765_p15569626"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="16.04%" headers="mcps1.1.5.1.3 "><p id="en-us_topic_0000001189111912_en-us_topic_0000001167913765_p46747472287"><a name="en-us_topic_0000001189111912_en-us_topic_0000001167913765_p46747472287"></a><a name="en-us_topic_0000001189111912_en-us_topic_0000001167913765_p46747472287"></a>int</p>
</td>
<td class="cellrowborder" valign="top" width="54.39000000000001%" headers="mcps1.1.5.1.4 "><p id="p16838162812163"><a name="p16838162812163"></a><a name="p16838162812163"></a>Physical chip ID, which is obtained by calling <a href="dcmiv2_get_chip_phy_id_by_dev_id.md">dcmiv2_get_chip_phy_id_by_dev_id</a>.</p>
</td>
</tr>
<tr id="en-us_topic_0000001189111912_row029010598584"><td class="cellrowborder" valign="top" width="15.72%" headers="mcps1.1.5.1.1 "><p id="en-us_topic_0000001189111912_p1845492116012"><a name="en-us_topic_0000001189111912_p1845492116012"></a><a name="en-us_topic_0000001189111912_p1845492116012"></a>dev_id</p>
</td>
...
<td class="cellrowborder" valign="top" width="16.04%" headers="mcps1.1.5.1.3 "><p id="en-us_topic_0000001189111912_p17454182115010"><a name="en-us_topic_0000001189111912_p17454182115010"></a><a name="en-us_topic_0000001189111912_p17454182115010"></a>unsigned int<strong id="b95301452193317"><a name="b95301452193317"></a><a name="b95301452193317"></a> *</strong></p>
</td>
<td class="cellrowborder" valign="top" width="54.39000000000001%" headers="mcps1.1.5.1.4 "><p id="p040331619351"><a name="p040331619351"></a><a name="p040331619351"></a><span id="ph1066114212549"><a name="ph1066114212549"></a><a name="ph1066114212549"></a>Logical ID of the software</span>.</p>
</td>
</tr>
</tbody>
</table>
...
This API is supported in the PM scenarios. The correctness of the results obtained in other container scenarios is not guaranteed.
...
ret = dcmiv2_get_dev_id_by_chip_phy_id(phyid, &dev_id);
if (ret != DCMI_OK) {
    printf("dcmiv2_get_dev_id_by_chip_phy_id failed. err is %d\n", ret);
}
return ret; 
...
```
