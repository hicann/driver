# dcmiv2\_get\_device\_system\_time<a name="EN-US_TOPIC_0000002347923997"></a>

## Prototype<a name="en-us_topic_0000001251307155_en-us_topic_0000001223172943_en-us_topic_0000001101564712_toc533412077"></a>

**int dcmiv2\_get\_device\_system\_time\(int dev\_id, unsigned int \*system\_time\)**
...
int dev_id = 0;
ret = dcmiv2_get_device_system_time(dev_id, &system_time);
if (ret != 0){
    // TODO: Record logs.
    return ret;
}
