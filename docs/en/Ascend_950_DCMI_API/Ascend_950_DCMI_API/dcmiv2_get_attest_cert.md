# dcmiv2\_get\_attest\_cert<a name="EN-US_TOPIC_0000002565332137"></a>

## Prototype<a name="en-us_topic_0000001206147244_en-us_topic_0000001223414441_en-us_topic_0000001099619850_toc533412077"></a>

**int dcmiv2\_get\_attest\_cert\(int dev\_id, unsigned char \*ak\_cert, unsigned int \*ak\_cert\_len\)**

## Description<a name="section1468480762"></a>

Obtains the Initial Attestation Key \(IAK\) certificate of a device and the certificate length.
...
<tr id="row7751112703217"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p12787612134616"><a name="p12787612134616"></a><a name="p12787612134616"></a>ak_cert</p>
</td>
<td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.2 "><p id="p8265132123911"><a name="p8265132123911"></a><a name="p8265132123911"></a>Output</p>
</td>
<td class="cellrowborder" valign="top" width="16%" headers="mcps1.1.5.1.3 "><p id="p1674131819463"><a name="p1674131819463"></a><a name="p1674131819463"></a>unsigned char *</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p102381130124616"><a name="p102381130124616"></a><a name="p102381130124616"></a>IAK certificate, whose length is up to 2 KB.</p>
</td>
</tr>
<tr id="row13163103243816"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p37875127468"><a name="p37875127468"></a><a name="p37875127468"></a>ak_cert_len</p>
</td>
<td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.2 "><p id="p112665220399"><a name="p112665220399"></a><a name="p112665220399"></a>Input/Output</p>
</td>
<td class="cellrowborder" valign="top" width="16%" headers="mcps1.1.5.1.3 "><p id="p2741171820462"><a name="p2741171820462"></a><a name="p2741171820462"></a>unsigned int *</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p923816309467"><a name="p923816309467"></a><a name="p923816309467"></a>Input: size of the space allocated by the user; output: actual data length.</p>
</td>
</tr>
</tbody>
</table>
...
ret = dcmiv2_init();
if (ret != 0) {
    printf("dcmiv2_init failed, ret = %d\n", ret);
    return ret;
}
ret = dcmiv2_get_attest_cert(dev_id, ak_cert, &ak_cert_len);
if (ret != 0) {
    printf("dcmiv2_get_attest_cert failed, ret = %d\n", ret);
    return ret;
}
...
```
