# dcmiv2\_get\_slot\_id\_and\_chip\_id\_by\_dev\_id<a name="EN-US_TOPIC_0000002524106138"></a>

## Prototype<a name="en-us_topic_0000001251227173_en-us_topic_0000001223292889_en-us_topic_0000001147723703_toc533412077"></a>

**int dcmiv2\_get\_slot\_id\_and\_chip\_id\_by\_dev\_id\(int dev\_id, unsigned int \*slot\_id, unsigned int \*chip\_id\)**

## Description<a name="en-us_topic_0000001251227173_en-us_topic_0000001223292889_en-us_topic_0000001147723703_toc533412078"></a>

Queries the physical slot ID and chip ID of a device based on the logical ID of the software.
...
<tr id="en-us_topic_0000001251227173_en-us_topic_0000001223292889_en-us_topic_0000001147723703_row15462171542913"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p9876144122716"><a name="p9876144122716"></a><a name="p9876144122716"></a>slot_id</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p12875841275"><a name="p12875841275"></a><a name="p12875841275"></a>Physical slot ID of a device.</p>
</td>
</tr>
<tr id="row19296110152114"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p9297111072118"><a name="p9297111072118"></a><a name="p9297111072118"></a>chip_id</p>
</td>
<td class="cellrowborder" valign="top" width="16.99%" headers="mcps1.1.5.1.2 "><p id="p21101028162112"><a name="p21101028162112"></a><a name="p21101028162112"></a>Output</p>
</td>
<td class="cellrowborder" valign="top" width="16.009999999999998%" headers="mcps1.1.5.1.3 "><p id="p9836103819212"><a name="p9836103819212"></a><a name="p9836103819212"></a>unsigned int<strong id="b1283693872116"><a name="b1283693872116"></a><a name="b1283693872116"></a> *</strong></p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p14297151062115"><a name="p14297151062115"></a><a name="p14297151062115"></a>Chip ID.</p>
</td>
</tr>
</tbody>
</table>
...
int ret;
int dev_id = 0;
unsigned int slot_id, chip_id;
ret = dcmiv2_get_slot_id_and_chip_id_by_dev_id(dev_id, &slot_id, &chip_id);
...
```
