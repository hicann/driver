# dcmiv2\_get\_topo\_info\_by\_device\_id<a name="EN-US_TOPIC_0000002347923993"></a>

## Prototype<a name="en-us_topic_0000001251107199_en-us_topic_0000001223414423_en-us_topic_0000001146259777_toc533412077"></a>

**int dcmiv2\_get\_topo\_info\_by\_device\_id \(int dev\_id1, int dev\_id2, int \*topo\_type\)**
...
<tbody><tr id="row1684271132614"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p11708131185016"><a name="p11708131185016"></a><a name="p11708131185016"></a>dev_id1/dev_id2</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><div class="p" id="p294414276267"><a name="p294414276267"></a><a name="p294414276267"></a>Topology relationship between devices. The mapping is as follows:<pre class="codeblock" id="codeblock620805516596"><a name="codeblock620805516596"></a><a name="codeblock620805516596"></a>typedef enum {
DCMI_TOPO_TYPE_SELF = 0, // Chip
DCMI_TOPO_TYPE_SYS, // Indicates the path traversing PCIe and NUMA nodes. The nodes are connected through SMP, such as QPI and UPI.
DCMI_TOPO_TYPE_PHB, // Indicates the path traversing PCIe and the PCIe host bridge of the same CPU.
DCMI_TOPO_TYPE_HCCS, // Indicates connection through HCCS.
DCMI_TOPO_TYPE_PXB, // Indicates the path traversing PCIe and multiple PCIe switches.
DCMI_TOPO_TYPE_PIX, // Indicates the path traversing PCIe and a PCIe switch.
DCMI_TOPO_TYPE_SIO, // Indicates connection through the SIO bus.
DCMI_TOPO_TYPE_HCCS_SW, // Indicates the HCCS connection through a switch.
DCMI_TOPO_TYPE_UB, // Indicates connection over UB.
DCMI_TOPO_TYPE_BUTT, // The mapping is unknown.
DCMI_TOPO_TYOE_MAX,
};</pre>
</div>
</td>
...
int dev_id2 = 1;
int result;
ret = dcmiv2_get_topo_info_by_device_id(dev_id1, dev_id2, &result);
...
```
