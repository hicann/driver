# Clearing the TLS Certificate Information of an NPU Device<a name="EN-US_TOPIC_0000002584611358"></a>
...
Clears TLS certificate information of the host or device.

## Precautions<a name="en-us_topic_0238914640_section127461744152119"></a>

- The host-side TLS CRL cannot be cleared separately.
- The clearing operation will clear the TLS certificate information of the device, which may affect the normal running of services that depend on TLS communication. Exercise caution when performing this operation.
...
<td class="cellrowborder" valign="top" width="56.28999999999999%" headers="mcps1.1.4.1.3 "><p id="p1153516518398"><a name="p1153516518398"></a><a name="p1153516518398"></a>Clears TLS certificates.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="13.76%" headers="mcps1.1.4.1.2 "><p id="p1341672604411"><a name="p1341672604411"></a><a name="p1341672604411"></a>Optional</p>
</td>
<td class="cellrowborder" valign="top" width="56.28999999999999%" headers="mcps1.1.4.1.3 "><p id="p1341614260445"><a name="p1341614260445"></a><a name="p1341614260445"></a>Clears the device-side TLS CRL. This option is mutually exclusive with <strong id="b19873174144014"><a name="b19873174144014"></a><a name="b19873174144014"></a>-host</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.28999999999999%" headers="mcps1.1.4.1.3 "><p id="p1017333911208"><a name="p1017333911208"></a><a name="p1017333911208"></a>If this option is specified, the host-side TLS information is cleared. If this option is not specified, the device-side TLS information is cleared by default.</p>
</td>
</tr>
</tbody>
</table>
...
- Example 1:
    ...
    Clear the device-side TLS certificate information for the device with logical ID 0.
...
- Example 2:
    ...
    Clear the host-side TLS certificate information for the device with logical ID 0.
...
- Example 3:
    ...
    Clear the device-side TLS CRL information for the device with logical ID 0.
