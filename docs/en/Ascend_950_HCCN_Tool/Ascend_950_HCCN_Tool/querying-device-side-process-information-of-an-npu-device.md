# Querying Device-Side Process Information of an NPU Device<a name="EN-US_TOPIC_0000002614811133"></a>
...
Queries whether the hccp\_service process exists on the device side.
...
Query device-side process information of the device with logical ID 0.

```text
device hccp process: exist
```
...
<tbody><tr id="row720695814162"><td class="cellrowborder" valign="top" width="30%" headers="mcps1.1.3.1.1 "><p id="p89889565145"><a name="p89889565145"></a><a name="p89889565145"></a>device hccp process</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p id="p13480153403918"><a name="p13480153403918"></a><a name="p13480153403918"></a>HCCP process running on the device:</p>
<a name="ul3803165020393"></a><a name="ul3803165020393"></a><ul id="ul3803165020393"><li><strong id="b12841135153912"><a name="b12841135153912"></a><a name="b12841135153912"></a>not exist</strong>: No HCCP process exists.</li><li><strong id="b82294918390"><a name="b82294918390"></a><a name="b82294918390"></a>exist</strong>: An HCCP process exists.</li></ul>
</td>
</tr>
</tbody>
</table>
