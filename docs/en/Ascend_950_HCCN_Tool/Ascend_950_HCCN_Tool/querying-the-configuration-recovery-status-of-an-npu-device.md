# Querying the Configuration Recovery Status of an NPU Device<a name="EN-US_TOPIC_0000002614931213"></a>
...
Queries the configuration recovery status of the device.
...
Query the configuration recovery status of the device with logical ID 0.

```text
config status:NONE
```

## Output Description<a name="section131941001091"></a>
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p199632211373"><a name="p199632211373"></a><a name="p199632211373"></a>Configuration recovery status:</p>
<a name="ul106175480216"></a><a name="ul106175480216"></a><ul id="ul106175480216"><li><strong id="b11420175416311"><a name="b11420175416311"></a><a name="b11420175416311"></a>NONE</strong>: Recovery is not started.</li><li><strong id="b2787141143"><a name="b2787141143"></a><a name="b2787141143"></a>START</strong>: Recovery is started but not complete.</li><li><strong id="b3852521641"><a name="b3852521641"></a><a name="b3852521641"></a>FAIL</strong>: Recovery failed.</li><li><strong id="b9829731240"><a name="b9829731240"></a><a name="b9829731240"></a>SUCCESS</strong>: Recovery is successful.</li></ul>
</td>
</tr>
</tbody>
</table>
