# Querying AEQ Context Information of a Network Device<a name="EN-US_TOPIC_0000002614811097"></a>
...
Queries Advanced Event Queue Context \(AEQC\).
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p871512133204"><a name="p871512133204"></a><a name="p871512133204"></a>UDMA device name. You can run the <a href="querying-the-npu-device-information.md">Querying the NPU Device Information</a> command to query the value, and the device name corresponds to <strong id="b1091518211804"><a name="b1091518211804"></a><a name="b1091518211804"></a>udma</strong><em id="i207980240018"><a name="i207980240018"></a><a name="i207980240018"></a>X</em> in the <strong id="b10351131315114"><a name="b10351131315114"></a><a name="b10351131315114"></a>Name</strong> field in the command output.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.1.4.1.2 "><p id="p2173173912205"><a name="p2173173912205"></a><a name="p2173173912205"></a>Required</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p1017333911208"><a name="p1017333911208"></a><a name="p1017333911208"></a>AEQC index. The value is <strong id="b206341731173211"><a name="b206341731173211"></a><a name="b206341731173211"></a>0</strong>.</p>
</td>
</tr>
</tbody>
</table>
...
Query the details about AEQC 0 of udma3 for the device with logical ID 0.
...
For details about the command output description, contact technical support engineers.
