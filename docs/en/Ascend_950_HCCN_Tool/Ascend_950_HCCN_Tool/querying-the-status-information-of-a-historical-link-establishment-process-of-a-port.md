# Querying the Status Information of a Historical Link Establishment Process of a Port<a name="EN-US_TOPIC_0000002584611382"></a>
...
Queries the status information of a port's historical link establishment process.

## Precautions<a name="section8415102071"></a>

You can query the historical link establishment information for a maximum of five times. The query results are displayed in reverse chronological order.
...
Query the status information of the historical link establishment process for port 4 on UDie 0 under logical device ID 0.
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p561783955811"><a name="p561783955811"></a><a name="p561783955811"></a><span id="ph357503174914"><a name="ph357503174914"></a><a name="ph357503174914"></a>Logical ID of the software</span>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p82243155816"><a name="p82243155816"></a><a name="p82243155816"></a>Chip UDie ID.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p1386617317589"><a name="p1386617317589"></a><a name="p1386617317589"></a>Chip port ID.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p4230441361"><a name="p4230441361"></a><a name="p4230441361"></a>Index of the output historical status entries. A maximum of five entries can be displayed. The value ranges from 0 to 4.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p0782185817356"><a name="p0782185817356"></a><a name="p0782185817356"></a>Link establishment timestamp.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p386123820119"><a name="p386123820119"></a><a name="p386123820119"></a>Current port mode. <strong id="b13478739164712"><a name="b13478739164712"></a><a name="b13478739164712"></a>UB</strong> and <strong id="b121018884816"><a name="b121018884816"></a><a name="b121018884816"></a>LANE raise</strong>.</p>
</td>
</tr>
</tbody>
</table>
