# Querying Queue Resource Attributes for a Network Device<a name="EN-US_TOPIC_0000002614811105"></a>
...
Queries queue resource attributes.

## Precautions<a name="en-us_topic_0238914640_section127461744152119"></a>

Before running this command to query the queue resource attributes, you can run the command in  [Querying the Queue Resource List for a Network Device](querying-the-queue-resource-list-for-a-network-device.md)  to check whether the resource type exists in the resource list. For example, if the value of  **jfs\_cnt**  is  **0**, the JFS resource type does not exist and cannot be queried. If the value of  **jfs\_cnt**  is not  **0**, the JFS resource type exists.
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.1.4.1.2 "><p id="p1197092620203"><a name="p1197092620203"></a><a name="p1197092620203"></a>Required</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="en-us_topic_0000002614811097_p871512133204"><a name="en-us_topic_0000002614811097_p871512133204"></a><a name="en-us_topic_0000002614811097_p871512133204"></a>UDMA device name. You can run the <a href="querying-the-npu-device-information.md">Querying the NPU Device Information</a> command to query the value, and the device name corresponds to <strong id="en-us_topic_0000002614811097_b1091518211804"><a name="en-us_topic_0000002614811097_b1091518211804"></a><a name="en-us_topic_0000002614811097_b1091518211804"></a>udma</strong><em id="en-us_topic_0000002614811097_i207980240018"><a name="en-us_topic_0000002614811097_i207980240018"></a><a name="en-us_topic_0000002614811097_i207980240018"></a>X</em> in the <strong id="en-us_topic_0000002614811097_b10351131315114"><a name="en-us_topic_0000002614811097_b10351131315114"></a><a name="en-us_topic_0000002614811097_b10351131315114"></a>Name</strong> field in the command output.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.1.4.1.2 "><p id="p89961527172020"><a name="p89961527172020"></a><a name="p89961527172020"></a>Required</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p529618106207"><a name="p529618106207"></a><a name="p529618106207"></a>Resource type. The value ranges from 5 to 11, corresponding to the <strong id="b887011418412"><a name="b887011418412"></a><a name="b887011418412"></a>JFS</strong>, <strong id="b1335915457414"><a name="b1335915457414"></a><a name="b1335915457414"></a>JFR</strong>, <strong id="b112099491142"><a name="b112099491142"></a><a name="b112099491142"></a>JETTY</strong>, <strong id="b114869527413"><a name="b114869527413"></a><a name="b114869527413"></a>JETTY_GROUP</strong>, <strong id="b344919559414"><a name="b344919559414"></a><a name="b344919559414"></a>JFC</strong>, <strong id="b38202571841"><a name="b38202571841"></a><a name="b38202571841"></a>RC</strong>, and <strong id="b33851741859"><a name="b33851741859"></a><a name="b33851741859"></a>SEG</strong> resource types, respectively.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.1.4.1.2 "><p id="p310622217019"><a name="p310622217019"></a><a name="p310622217019"></a>Required</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p12576135775718"><a name="p12576135775718"></a><a name="p12576135775718"></a>Resource ID.</p>
</td>
</tr>
</tbody>
</table>
...
Query the attributes of the JFR resource \(with ID 4\) of udma3 for the device whose logical ID is 0.
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p id="p18974531822"><a name="p18974531822"></a><a name="p18974531822"></a>JFR resource ID.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p id="p1945011181915"><a name="p1945011181915"></a><a name="p1945011181915"></a>Resource status.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p id="p155751159171813"><a name="p155751159171813"></a><a name="p155751159171813"></a>Resource depth.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p id="p141331215152914"><a name="p141331215152914"></a><a name="p141331215152914"></a>JFC resource ID.</p>
</td>
</tr>
</tbody>
</table>
