# Querying the Real-Time Bandwidth Information of a Port<a name="EN-US_TOPIC_0000002584611350"></a>
...
Queries the real-time bandwidth information of a port.
...
Query the real-time bandwidth information of port 4 on UDie 0 under logical device ID 0.

```text
Bandwidth TX:       0.00 MB/sec
Bandwidth RX:     266.84 MB/sec
```
...
<tbody><tr id="row720695814162"><td class="cellrowborder" valign="top" width="30%" headers="mcps1.1.3.1.1 "><p id="p165819613567"><a name="p165819613567"></a><a name="p165819613567"></a>Bandwidth TX</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p id="p1169312241518"><a name="p1169312241518"></a><a name="p1169312241518"></a>Bandwidth transmission rate.</p>
</td>
</tr>
<tr id="row1545515094515"><td class="cellrowborder" valign="top" width="30%" headers="mcps1.1.3.1.1 "><p id="p345520154519"><a name="p345520154519"></a><a name="p345520154519"></a>Bandwidth RX</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p id="p945514084513"><a name="p945514084513"></a><a name="p945514084513"></a>Bandwidth receiving rate.</p>
</td>
</tr>
</tbody>
</table>
