# Querying the Port Link Status<a name="EN-US_TOPIC_0000002614931223"></a>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p17451457141517"><a name="p17451457141517"></a><a name="p17451457141517"></a><span id="ph16119162121517"><a name="ph16119162121517"></a><a name="ph16119162121517"></a>Logical ID of the software</span>. The <strong id="b823820395231"><a name="b823820395231"></a><a name="b823820395231"></a>NPU ID</strong> field queried by running the <strong id="b203142152219"><a name="b203142152219"></a><a name="b203142152219"></a>npu-smi info</strong> command is the value of the <strong id="b38385413386"><a name="b38385413386"></a><a name="b38385413386"></a>-i</strong> parameter.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p16538337122410"><a name="p16538337122410"></a><a name="p16538337122410"></a>Chip UDie ID. The value is <strong id="b4277211143916"><a name="b4277211143916"></a><a name="b4277211143916"></a>0</strong>. You can run the command in <a href="querying-the-npu-device-information.md">Querying the NPU Device Information</a> to query the value.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p1911115561611"><a name="p1911115561611"></a><a name="p1911115561611"></a>Chip port ID. For details, see <strong id="b15791243184015"><a name="b15791243184015"></a><a name="b15791243184015"></a>Port ID</strong> in the output description in <a href="querying-the-npu-device-information.md">Querying the NPU Device Information</a>.</p>
</td>
</tr>
</tbody>
</table>
...
Query the link status of port 4 on UDie 0 under logical device ID 0.
...
<tbody><tr id="row720695814162"><td class="cellrowborder" valign="top" width="30%" headers="mcps1.1.3.1.1 "><p id="p1980410351559"><a name="p1980410351559"></a><a name="p1980410351559"></a>link status</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p id="p41945818510"><a name="p41945818510"></a><a name="p41945818510"></a>Link status:</p>
<a name="ul17710328135210"></a><a name="ul17710328135210"></a><ul id="ul17710328135210"><li><strong id="b78562681712"><a name="b78562681712"></a><a name="b78562681712"></a>UP</strong>: The connection is normal.</li><li><strong id="b9896141210171"><a name="b9896141210171"></a><a name="b9896141210171"></a>DOWN</strong>: The connection is interrupted.</li></ul>
</td>
</tr>
</tbody>
</table>
