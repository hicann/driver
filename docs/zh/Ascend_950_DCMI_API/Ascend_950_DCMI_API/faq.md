# faq<a name="ZH-CN_TOPIC_0000002314045198"></a>

## 准备ipmitool软件<a name="ZH-CN_TOPIC_0000002347924077"></a>
...
3. 执行如下命令，查看驱动是否加载成功。
    ...
    **lsmod | grep ipmi**
    ...
    如果没有加载成功，执行步骤2重新加载驱动。

    > **说明：** 
    >
    > 如果重启OS后，需要重新执行步骤2和步骤3。

## 查询NPU业务进程<a name="ZH-CN_TOPIC_0000002347923977"></a>
