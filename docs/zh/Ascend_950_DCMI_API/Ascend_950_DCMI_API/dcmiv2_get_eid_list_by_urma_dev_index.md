# dcmiv2\_get\_eid\_list\_by\_urma\_dev\_index<a name="ZH-CN_TOPIC_0000002487017104"></a>
...
获取指定芯片上对应URMA device的EID（entity ID）列表。
...
<tr id="zh-cn_topic_0000001251227173_zh-cn_topic_0000001223292889_zh-cn_topic_0000001147723703_row15462171542913"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p22401876345"><a name="p22401876345"></a><a name="p22401876345"></a>dev_index</p>
</td>
<td class="cellrowborder" valign="top" width="16.99%" headers="mcps1.1.5.1.2 "><p id="p18431094340"><a name="p18431094340"></a><a name="p18431094340"></a>输入</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p184269133419"><a name="p184269133419"></a><a name="p184269133419"></a>URMA device编号，通过<a href="dcmiv2_get_urma_device_cnt.md">dcmiv2_get_urma_device_cnt</a>接口获取。取值范围[0, dev_cnt-1]。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="16.99%" headers="mcps1.1.5.1.2 "><p id="p12554712163413"><a name="p12554712163413"></a><a name="p12554712163413"></a>输出</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p195541012143416"><a name="p195541012143416"></a><a name="p195541012143416"></a>URMA device的EID列表，约定最大长度为32个EID。</p>
<p id="p6916182711502"><a name="p6916182711502"></a><a name="p6916182711502"></a>dcmi_urma_eid_info_t的信息结构体定义：</p>
...
<p id="p129881953114911"><a name="p129881953114911"></a><a name="p129881953114911"></a>unsigned char raw[DCMI_URMA_EID_SIZE]; /* 完整未经解析的EID */</p>
...
<p id="p179881553124915"><a name="p179881553124915"></a><a name="p179881553124915"></a>} in4;          /* 把EID作为IPv4解析 */</p>
...
<p id="p1098855324912"><a name="p1098855324912"></a><a name="p1098855324912"></a>} in6;          /* 把EID作为IPv6解析 */</p>
...
<td class="cellrowborder" valign="top" width="16.99%" headers="mcps1.1.5.1.2 "><p id="p993891403414"><a name="p993891403414"></a><a name="p993891403414"></a>输入/输出</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><a name="ul1948102514227"></a><a name="ul1948102514227"></a><ul id="ul1948102514227"><li>输入表示EID列表长度，最大长度为32个EID。</li><li>输出表示URMA device的EID数量。</li></ul>
</td>
</tr>
</tbody>
</table>
