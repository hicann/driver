# dcmiv2\_get\_dcmi\_version<a name="ZH-CN_TOPIC_0000002314045202"></a>

## 函数原型<a name="zh-cn_topic_0000001206627196_zh-cn_topic_0000001178213188_zh-cn_topic_0000001146459833_toc533412077"></a>

**int dcmiv2\_get\_dcmi\_version\(char \*dcmi\_ver, unsigned int len\)**
...
int ret;
char dcmi_ver[16] = {0};
ret = dcmiv2_get_dcmi_version(dcmi_ver, sizeof(dcmi_ver));
…
```
