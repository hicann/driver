# dcmiv2\_get\_netdev\_pkt\_stats\_info<a name="ZH-CN_TOPIC_0000002347924073"></a>

## 函数原型<a name="zh-cn_topic_0000001251107199_zh-cn_topic_0000001223414423_zh-cn_topic_0000001146259777_toc533412077"></a>

**int dcmiv2\_get\_netdev\_pkt\_stats\_info\(int dev\_id, int port\_id, struct dcmi\_network\_pkt\_stats\_info \*network\_pkt\_stats\_info\)**
...
<td class="cellrowborder" valign="top" width="22.1%" headers="mcps1.1.5.1.3 "><p id="p970973119509"><a name="p970973119509"></a><a name="p970973119509"></a>int</p>
</td>
<td class="cellrowborder" valign="top" width="43.91%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0000002348043873_p1761223114720"><a name="zh-cn_topic_0000002348043873_p1761223114720"></a><a name="zh-cn_topic_0000002348043873_p1761223114720"></a><span id="zh-cn_topic_0000002348043873_ph1263073113614"><a name="zh-cn_topic_0000002348043873_ph1263073113614"></a><a name="zh-cn_topic_0000002348043873_ph1263073113614"></a>软件的逻辑ID</span>，通过<a href="dcmiv2_get_device_list.md">dcmiv2_get_device_list</a>接口获取。取值范围为[0, device_cnt-1]。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="22.1%" headers="mcps1.1.5.1.3 "><p id="p1424112357410"><a name="p1424112357410"></a><a name="p1424112357410"></a>int</p>
</td>
<td class="cellrowborder" valign="top" width="43.91%" headers="mcps1.1.5.1.4 "><p id="p1224183544119"><a name="p1224183544119"></a><a name="p1224183544119"></a>NPU设备的网口端口号，当前仅支持配置0。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="22.1%" headers="mcps1.1.5.1.3 "><p id="p3908831194215"><a name="p3908831194215"></a><a name="p3908831194215"></a>struct dcmi_network_pkt_stats_info<strong id="b1793792141419"><a name="b1793792141419"></a><a name="b1793792141419"></a> </strong>*</p>
</td>
<td class="cellrowborder" valign="top" width="43.91%" headers="mcps1.1.5.1.4 "><p id="p1290823174218"><a name="p1290823174218"></a><a name="p1290823174218"></a>struct dcmi_network_pkt_stats_info {</p>
...
ret = dcmiv2_get_netdev_pkt_stats_info (dev_id, port_id, &network_pkt_stats_info);
if (ret != 0){
    //todo：记录日志
    return ret;
}
