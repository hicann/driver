# dcmiv2\_get\_urma\_device\_cnt<a name="ZH-CN_TOPIC_0000002519017001"></a>
...
获取指定设备的URMA（Unified Remote Memory Access） device数量。
...
<tr id="zh-cn_topic_0000001251227173_zh-cn_topic_0000001223292889_zh-cn_topic_0000001147723703_row15462171542913"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p9876144122716"><a name="p9876144122716"></a><a name="p9876144122716"></a>dev_cnt</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p12875841275"><a name="p12875841275"></a><a name="p12875841275"></a>URMA device数量。</p>
</td>
</tr>
</tbody>
</table>
