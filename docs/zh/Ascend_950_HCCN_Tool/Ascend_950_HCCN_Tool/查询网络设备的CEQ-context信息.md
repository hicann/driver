# 查询网络设备的CEQ context信息<a name="ZH-CN_TOPIC_0000002584611376"></a>
...
<tr id="row1817383952015"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.1.4.1.1 "><p id="p7173839152017"><a name="p7173839152017"></a><a name="p7173839152017"></a>-ceqc &lt;ceq_id&gt;</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p1017333911208"><a name="p1017333911208"></a><a name="p1017333911208"></a>指定CEQ类型的context索引编号（ceqc：Completion Event Queue Context），取值：0。</p>
</td>
</tr>
</tbody>
</table>
...
查询逻辑设备ID为0的udma3设备的CEQ类型context索引0的详细信息。
