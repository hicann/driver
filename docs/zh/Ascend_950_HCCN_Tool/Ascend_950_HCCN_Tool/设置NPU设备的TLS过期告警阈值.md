# 设置NPU设备的TLS过期告警阈值<a name="ZH-CN_TOPIC_0000002584451456"></a>
...
<td class="cellrowborder" valign="top" width="56.28999999999999%" headers="mcps1.1.4.1.3 "><p id="p1153516518398"><a name="p1153516518398"></a><a name="p1153516518398"></a>TLS过期告警阈值。取值范围：7~180[天]，默认60天。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="56.28999999999999%" headers="mcps1.1.4.1.3 "><p id="p1963762592719"><a name="p1963762592719"></a><a name="p1963762592719"></a>指定设置Host侧TLS信息。无该项时默认设置Device侧信息。</p>
</td>
</tr>
</tbody>
</table>
