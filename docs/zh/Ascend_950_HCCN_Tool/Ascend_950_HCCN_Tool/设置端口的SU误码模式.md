# 设置端口的SU误码模式<a name="ZH-CN_TOPIC_0000002584611366"></a>
...
- 该命令设置成功后，可执行[查询端口的SU误码模式和误码统计结果](查询端口的SU误码模式和误码统计结果.md)命令查询设置的误码模式。
- 设置SU误码模式时，需保证配置时序，应先开启一个设备端口为发送功能，再配置互连的另一设备端口为接收功能开启。设置完成后，误码统计结果在接收端口通过[查询端口的SU误码模式和误码统计结果](查询端口的SU误码模式和误码统计结果.md)命令查询。
...
<th class="cellrowborder" valign="top" width="26.11%" id="mcps1.1.4.1.2"><p id="p14928362410"><a name="p14928362410"></a><a name="p14928362410"></a>可选/必选</p>
</th>
<th class="cellrowborder" valign="top" width="56.330000000000005%" id="mcps1.1.4.1.3"><p id="zh-cn_topic_0184799386_p83121275519"><a name="zh-cn_topic_0184799386_p83121275519"></a><a name="zh-cn_topic_0184799386_p83121275519"></a>说明</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="26.11%" headers="mcps1.1.4.1.2 "><p id="p20463164634118"><a name="p20463164634118"></a><a name="p20463164634118"></a>必选</p>
</td>
<td class="cellrowborder" valign="top" width="56.330000000000005%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0000002614931223_p16538337122410"><a name="zh-cn_topic_0000002614931223_p16538337122410"></a><a name="zh-cn_topic_0000002614931223_p16538337122410"></a>芯片UDie ID。取值：0。可通过<a href="查询NPU设备信息.md">查询NPU设备信息</a>命令查询。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="26.11%" headers="mcps1.1.4.1.2 "><p id="p84833461411"><a name="p84833461411"></a><a name="p84833461411"></a>必选</p>
</td>
<td class="cellrowborder" valign="top" width="56.330000000000005%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0000002614931223_p1911115561611"><a name="zh-cn_topic_0000002614931223_p1911115561611"></a><a name="zh-cn_topic_0000002614931223_p1911115561611"></a>芯片端口ID，详见<a href="查询NPU设备信息.md">查询NPU设备信息</a>命令输出说明中的“Port ID”。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="26.11%" headers="mcps1.1.4.1.2 "><p id="p147061908137"><a name="p147061908137"></a><a name="p147061908137"></a>必选</p>
</td>
<td class="cellrowborder" valign="top" width="56.330000000000005%" headers="mcps1.1.4.1.3 "><p id="p870613011318"><a name="p870613011318"></a><a name="p870613011318"></a>SU误码模式：</p>
<a name="ul820193403715"></a><a name="ul820193403715"></a><ul id="ul820193403715"><li>tx_enable：开启发送功能。</li><li>rx_enable：开启接收功能。</li><li>stop：停止工作。未配置时，默认为stop。</li></ul>
</td>
</tr>
</tbody>
</table>
...
设置逻辑设备ID为0的UDie 0端口4的SU误码模式为开启接收功能。
