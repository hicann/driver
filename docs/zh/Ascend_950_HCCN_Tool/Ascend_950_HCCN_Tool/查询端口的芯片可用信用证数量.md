# 查询端口的芯片可用信用证数量<a name="ZH-CN_TOPIC_0000002614931219"></a>
...
查询逻辑设备ID为0的UDie 0的端口4的芯片可用信用证数量。
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p14232719153"><a name="p14232719153"></a><a name="p14232719153"></a>分配的端口共享信用证数量。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p529131115152"><a name="p529131115152"></a><a name="p529131115152"></a>当前使用的端口共享信用证数量。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p175741056101718"><a name="p175741056101718"></a><a name="p175741056101718"></a><span>虚拟链路（VL）优先级信用证分配数量</span>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60.24%" headers="mcps1.1.3.1.2 "><p id="p8114131715183"><a name="p8114131715183"></a><a name="p8114131715183"></a><span>虚拟链路（VL）优先级信用证使用数量</span>。</p>
</td>
</tr>
</tbody>
</table>
