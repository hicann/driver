# 查询端口的连接状态<a name="ZH-CN_TOPIC_0000002614931223"></a>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p17451457141517"><a name="p17451457141517"></a><a name="p17451457141517"></a><span id="ph13800154794716"><a name="ph13800154794716"></a><a name="ph13800154794716"></a>软件的逻辑ID</span>。执行<strong id="b203142152219"><a name="b203142152219"></a><a name="b203142152219"></a>npu-smi info</strong>命令查询到的“NPU ID”字段值即为-i参数取值。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p16538337122410"><a name="p16538337122410"></a><a name="p16538337122410"></a>芯片UDie ID。取值：0。可通过<a href="查询NPU设备信息.md">查询NPU设备信息</a>命令查询。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.3 "><p id="p1911115561611"><a name="p1911115561611"></a><a name="p1911115561611"></a>芯片端口ID，详见<a href="查询NPU设备信息.md">查询NPU设备信息</a>命令输出说明中的“Port ID”。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.3.1.2 "><p id="p41945818510"><a name="p41945818510"></a><a name="p41945818510"></a>连接状态：</p>
<a name="ul17710328135210"></a><a name="ul17710328135210"></a><ul id="ul17710328135210"><li>UP：连接正常。</li><li>DOWN：连接中断。</li></ul>
</td>
</tr>
</tbody>
</table>
