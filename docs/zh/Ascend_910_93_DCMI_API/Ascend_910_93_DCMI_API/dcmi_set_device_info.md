...
<td class="cellrowborder" valign="top" width="51.7%" headers="mcps1.1.5.1.4 "><p id="p96461212173514"><a name="p96461212173514"></a><a name="p96461212173514"></a>详见子章节中的功能说明。</p>
</td>
</tr>
...
AI CPU算子免权签使能状态默认为禁用，设置芯片的AI CPU算子免权签使能状态为使能后，若持久化功能为开启状态，则重启系统后AI CPU算子免权签使能状态不变。。
